...
* Template files can reside in the parent or current theme, the CSkola::ThemeEngineRender()
...
*
* path: Path to current theme, relativly SKOLA_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
...
$ly->config['theme'] = array(
  ...
  'data' => array(
    ...
    'logo_width' => 80,
    'logo_height' => 80,
    'footer' => '<p>Skola - .: Daniel Svensson :.</p>',
  ),
);
