...
function get_debug() {
  ...
  if(isset($ly->config['debug']['webbit']) && $ly->config['debug']['skola']) {
...
function create_url($urlOrController=null, $method=null, $arguments=null) {
  return CSkola::Instance()->CreateUrl($urlOrController, $method, $arguments);
}
...
function theme_url($url) {
  return create_url(CSkola::Instance()->themeUrl . "/{$url}");
}
...
function theme_parent_url($url) {
  return create_url(CSkola::Instance()->themeParentUrl . "/{$url}");
}
...
function render_views($region='default') {
  return CSkola::Instance()->views->Render($region);
}
...
function region_has_content($region='default' /*...*/) {
  return CSkola::Instance()->views->RegionHasView(func_get_args());
}
